// Завдання 1. Створіть об'єкт person за допомогою конструктора з полями name: "John", age: 25
...
let personLarge = {
  ...
  // Використовуємо деструктурізацію для створення об'єкту address
let { name, age } = personLarge;
let personAddress = {
  street: '123 Main St',
  city: 'New York',
  country: 'USA',
...
// Додаємо об'єкт address до об'єкта personLarge
personLarge = {
  name,
  age,
...
introduce: function() {
  // Використовуємо ключове слово this для отримання значень властивостей об'єкта
...
function addProperty(array) {
  ...
  Object.defineProperty(Array.prototype, 'customProperty', {
    value: 'myProperty',
    enumerable: false, // Зроблюємо властивість непереліченою, щоб не впливала на ітерацію по масиву
    writable: true, // Дозволяємо перезапис значення
    configurable: true, // Дозволяємо зміну конфігурації
  });
